...
check-dir:
	@test -d chat-app || (echo "Error: Directorio chat-app no encontrado. Ejecutar desde raiz del proyecto." && false)
	@test -f chat-app/go.mod || (echo "Error: go.mod no encontrado en chat-app/." && false)
